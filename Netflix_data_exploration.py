...
# durations_df = durations_df.rename_axis('release_years').rename(columns= {0:'durations'})
# durations_df = durations_df.set_index(pd.RangeIndex(start=0, stop=0+len(durations_df)))
# durations_df = durations_df.rename(columns= {'years':'release_years'})
...
netflix_movies_col_subset = netflix_df_movies_only[selected_columns]
